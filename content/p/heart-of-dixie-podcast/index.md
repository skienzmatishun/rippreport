...
date: 2025-11-21
youtube: x66tCHtLur4
thumbnail: img/heart-of-dixie-podcast.png
categories:
- dixie-podcast
authors:
- admin
...
- slug: a-slap-on-the-wrist
  ...
  category_score: 0
  rank: 10
alttags: A sticker on a dark blue background showing the outline of Alabama with OF
  DIXIE text, a red heart, and a crossed-out Confederate flag
summary: Leaked audio and secret police emails reveal shocking First Amendment retaliation
  occurring right inside Bay Minette. A local councilman makes explicit threats on
  tape while sheriff deputies receive directives to pre-target specific political
  critics. Catch this episode of the Heart of Dixie podcast to hear the unedited truth
